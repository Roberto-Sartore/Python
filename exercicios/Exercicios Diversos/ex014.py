...
peso = float(input('Quantos quilos foram pescados?: ').replace(',', '.'))
if peso <= 50:
    print(f'O peso de {peso:.2f} kg está de acordo com regulamento')
elif peso > 50:
    excesso = peso - 50
    multa = excesso * 4
    print(f'O peso excedente é {excesso:.2f} kg e o valor da multa é R$ {multa:.2f} ')
